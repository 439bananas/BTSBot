...
function ErrorDiag(props) {
    switch (props.err) {
        ...
        default:
            return <span>{translate(props.language, "page_confunknownerrordiag")} <a href={props.uniconf.discord}> {translate(props.language, 'global_discorderver')} </a> {translate(props.language, 'page_serverlostconnectiondiagpart3')}</span>
    }
};
...
function ErrorMessage(props) {
    switch (props.err) {
        case false:
            return (<p>{translate(props.language, 'page_noconfintropart1')} <code>conf.json</code> {translate(props.language, 'page_noconfintropart2') + props.confPath + translate(props.language, 'page_noconfintropart3') + props.uniconf.projname + translate(props.language, 'page_noconfintropart4')}<br /><ErrorDiag err={props.err} language={props.language} /></p>)
        case "MISSING_FIELDS":
        ...
        case "CONNECTION_REFUSED":
            return (<p>{props.uniconf.projname + translate(props.language, 'page_noconfintroconnectionrefused')}<br /><ErrorDiag err={props.err} language={props.language} /></p>)
        case "INCORRECT_CREDENTIALS":
            return (<p>{props.uniconf.projname + translate(props.language, 'page_noconfintroincorrectcredentials')}<br /><ErrorDiag err={props.err} language={props.language} /></p>)
        case "ACCESS_DENIED":
            return (<p>{props.uniconf.projname + translate(props.language, 'page_noconfintroaccessdenied')}<br /><ErrorDiag err={props.err} language={props.language} /></p>)
        case "REDIS_CONNECTION_REFUSED":
            return (<p>{props.uniconf.projname + translate(props.language, 'page_noconfintroredisconnectionrefused')}<br /><ErrorDiag err={props.err} language={props.language} /></p>)
        case "WRONGPASS":
            return (<p>{props.uniconf.projname + translate(props.language, 'page_noconfintroincorrectcredentials')}<br /><ErrorDiag err={props.err} language={props.language} /></p>)
        case "BAD_DATABASE":
        ...
        default:
            ...
            return (<p>{translate(props.language, 'page_noconfintrounknowndiscorderror1') + props.uniconf.projname + translate(props.language, 'page_noconfintrounknowndiscorderror2')}<br /><ErrorDiag err={props.err} language={props.language} uniconf={props.uniconf} /></p>)
    };
};
